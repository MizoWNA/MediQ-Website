...
interface MentorSectionProps {
  ...
  // Mentor data is fetched by the section itself.
}
...
function formatAcademicYear(year: number | null) {
  if (!year) return null;
...
console.log("ONBOARDING MENTOR QUERY:", {
  ...
  error: profileError,
        ...
        console.error(
          "Failed to load onboarding mentor:",
          err
        );
  ...
  const academicYear = mentor
    ? formatAcademicYear(mentor.year)
    : null;
        ...
        <div className="flex w-full flex-col items-center gap-10 lg:flex-row lg:items-center lg:gap-14">
            ...
            <div className="relative w-full max-w-[260px] overflow-hidden rounded-2xl border border-white/[0.08] bg-[#111419]/80 p-5 shadow-[0_20px_60px_rgba(0,0,0,0.18)] backdrop-blur-sm">
              ...
              <div className="relative mb-5 flex justify-center">
                ...
                <div className="relative flex h-24 w-24 items-center justify-center overflow-hidden rounded-full border border-white/[0.1] bg-[#181c21]">
                  {loading ? (
                    <div className="h-5 w-5 animate-pulse rounded-full border border-white/10 bg-white/[0.06]" />
                  ) : mentor && avatarSrc && !avatarError ? (
                    <img
                      src={avatarSrc}
                      alt={mentor.name}
                    ...
                    <UserRound className="h-8 w-8 text-white/15" />
                  )}
                </div>
              </div>
              ...
              <div className="relative text-center">
                {loading ? (
                  <>
                    <div className="mx-auto h-4 w-32 animate-pulse rounded bg-white/[0.06]" />
                    <div className="mx-auto mt-2 h-2.5 w-20 animate-pulse rounded bg-white/[0.04]" />
                  </>
                ) : mentor ? (
                  <>
                  ...
                  <>
                    ...
                    <p className="mx-auto mt-2 max-w-[180px] text-[9px] leading-4 text-white/25">
                      Your mentor will appear here once
          ...
          <div className="min-w-0 flex-1 text-center lg:text-left">
            ...
            <p className="mx-auto mt-5 max-w-md text-sm leading-7 text-white/40 sm:text-base lg:mx-0">
              Your mentor is here to help you make sense
              of your progress, plan what comes next, and
              give you someone to turn to when you need
              guidance.
            </p>
            ...
            <div className="mx-auto mt-7 max-w-md space-y-4 lg:mx-0">
              <div className="flex items-start gap-3 text-left">
                ...
                <div>
                  ...
                  <p className="mt-1 text-[11px] leading-5 text-white/25">
                    Get another perspective when you're
              ...
              <div className="flex items-start gap-3 text-left">
                ...
                <div>
                  ...
                  <p className="mt-1 text-[11px] leading-5 text-white/25">
                    Turn your plans into goals you can
