...
const testimonials = [
  {
    quote: "You were so helpful, you cant even imagine! On the days i couldn't get anything done you helped me find where to start!",
    author: "Anonymous",
    role: "1st Year",
  ...
  },
  {
    ...
    {
    quote: "Your support and time-management skills have boosted my confidence in myself to a level i didn't think was possible... Thank you.",
    author: "Anonymous",
    role: "3rd Year",
...
export function TestimonialsSection() {
  ...
  return (
    <section id="testamonials" className="relative py-32 lg:py-40 border-t border-foreground/10 lg:pb-14">
